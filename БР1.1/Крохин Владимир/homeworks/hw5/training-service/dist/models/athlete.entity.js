 ...
 */
let AthleteEntity = (() => {
  let _classDecorators = [(0, typeorm_1.Entity)('athletes')];
  ...
  let _coaches_decorators;
  let _coaches_initializers = [];
  let _coaches_extraInitializers = [];
  var AthleteEntity = (_classThis = class extends _classSuper {
    constructor() {
      super(...arguments);
      ...
      this.coaches =
        ...
        __runInitializers(this, _coaches_initializers, void 0));
      __runInitializers(this, _coaches_extraInitializers);
    }
  });
  __setFunctionName(_classThis, 'AthleteEntity');
  (() => {
    var _a;
    const _metadata =
    ...
    __esDecorate(
      ...
      _coaches_initializers,
      _coaches_extraInitializers,
    );
    __esDecorate(
      null,
    ...
    AthleteEntity = _classThis = _classDescriptor.value;
    if (_metadata)
  ...
  return (AthleteEntity = _classThis);
})();
