...
let QualificationTrainingEntity = (() => {
  ...
  let _exercise_id_decorators;
  let _exercise_id_initializers = [];
  let _exercise_id_extraInitializers = [];
  var QualificationTrainingEntity = (_classThis = class extends _classSuper {
    constructor() {
      ...
      this.exercise_id =
        ...
        __runInitializers(this, _exercise_id_initializers, void 0));
      __runInitializers(this, _exercise_id_extraInitializers);
    }
  });
  ...
  (() => {
    ...
    _exercise_id_decorators = [(0, typeorm_1.Column)({ type: 'smallint' })];
    __esDecorate(
      null,
      null,
      _id_decorators,
    ...
    __esDecorate(
      ...
      _exercise_id_decorators,
      {
        ...
        private: false,
        access: {
          has: obj => 'exercise_id' in obj,
          get: obj => obj.exercise_id,
          set: (obj, value) => {
            obj.exercise_id = value;
          },
        },
        metadata: _metadata,
      },
      _exercise_id_initializers,
      _exercise_id_extraInitializers,
    );
    __esDecorate(
      null,
