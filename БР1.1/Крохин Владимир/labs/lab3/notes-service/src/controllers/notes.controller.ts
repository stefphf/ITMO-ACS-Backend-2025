...
export class NotesController {
  ...
  async getNoteById(@Param('id') id: number, @Req() req: RequestWithUser): Promise<NoteDto> {
  ...
  async createNote(@Body() dto: CreateNoteDto, @Req() req: RequestWithUser): Promise<NoteDto> {
  ...
  async deleteNote(@Param('id') id: number, @Req() req: RequestWithUser): Promise<void> {
