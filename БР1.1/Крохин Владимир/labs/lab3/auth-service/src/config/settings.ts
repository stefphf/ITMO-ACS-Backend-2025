...
class Settings {
  ...
  APP_CONTROLLERS_PATH: string = process.env.APP_CONTROLLERS_PATH || '/controllers/*.controller.js';
  ...
  JWT_ACCESS_TOKEN_LIFETIME: number = parseInt(process.env.JWT_ACCESS_TOKEN_LIFETIME || '86400000');
}
