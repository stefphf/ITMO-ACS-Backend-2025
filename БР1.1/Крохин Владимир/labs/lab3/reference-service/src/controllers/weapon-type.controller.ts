...
import { CreateWeaponTypeDto, WeaponTypeDto, UpdateWeaponTypeDto } from '../dtos/reference.dto';
...
export class WeaponTypeController {
  ...
  async createWeaponType(@Body() dto: CreateWeaponTypeDto): Promise<WeaponTypeDto> {
