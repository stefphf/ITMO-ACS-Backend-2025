...
describe('Тесты интеграции TrainingNoteController', () => {
    ...
    describe('POST /trainings/:trainingId/notes', () => {
        it('должен создать заметку к тренировке с валидным токеном тренера', async () => {
            const noteData = {
                content: 'Test training note',
                type: 'COMMENT'
            };
        ...
        it('не должен создать заметку к тренировке без токена', async () => {
            const noteData = {
                content: 'Test training note',
                type: 'COMMENT'
            };
        ...
        it('не должен создать заметку к тренировке с токеном спортсмена', async () => {
            const noteData = {
                content: 'Test training note',
                type: 'COMMENT'
            };
    ...
    describe('GET /trainings/:trainingId/notes', () => {
        it('должен получить список заметок к тренировке с валидным токеном', async () => {
            const response = await request(app)
        ...
        it('не должен получить список заметок к тренировке без токена', async () => {
            const response = await request(app)
                .get(`/trainings/${trainingId}/notes`);
    ...
    describe('GET /trainings/:trainingId/notes/:noteId', () => {
        ...
        it('должен получить заметку к тренировке с валидным токеном', async () => {
            const response = await request(app)
        ...
        it('не должен получить заметку к тренировке без токена', async () => {
            const response = await request(app)
                .get(`/trainings/${trainingId}/notes/${noteId}`);
        ...
        it('не должен получить несуществующую заметку к тренировке', async () => {
            const response = await request(app)
    ...
    describe('PUT /trainings/:trainingId/notes/:noteId', () => {
        ...
        it('должен обновить заметку к тренировке с валидным токеном тренера', async () => {
            const updateData = {
                content: 'Updated training note',
                type: 'COMMENT'
            };
        ...
        it('не должен обновить заметку к тренировке без токена', async () => {
            const updateData = {
                content: 'Updated training note',
                type: 'COMMENT'
            };
        ...
        it('не должен обновить заметку к тренировке с токеном спортсмена', async () => {
            const updateData = {
                content: 'Updated training note',
                type: 'COMMENT'
            };
    ...
    describe('DELETE /trainings/:trainingId/notes/:noteId', () => {
        ...
        it('должен удалить заметку к тренировке с валидным токеном тренера', async () => {
            const response = await request(app)
        ...
        it('не должен удалить заметку к тренировке без токена', async () => {
            const response = await request(app)
                .delete(`/trainings/${trainingId}/notes/${noteId}`);
        ...
        it('не должен удалить заметку к тренировке с токеном спортсмена', async () => {
            const response = await request(app)
                .delete(`/trainings/${trainingId}/notes/${noteId}`)
                .set('Authorization', `Bearer ${athleteAuthToken}`);
