...
const createSkillDto_1 = require("../dtos/createSkillDto");
let SkillController = class SkillController {
    constructor() {
        this._service = new SkillService_1.SkillService();
    }
    createSkill(skill) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._service.post(skill);
        });
    }
    getAllSkill() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateSkill(id, skill) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._service.patch(id, skill);
        });
    }
    deleteSkill(id) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    ...
    __metadata("design:paramtypes", [createSkillDto_1.CreateSkillDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SkillController.prototype, "getAllSkill", null);
__decorate([
    (0, routing_controllers_1.UseBefore)(auth_1.default),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, createSkillDto_1.CreateSkillDto]),
    __metadata("design:returntype", Promise)
...
exports.SkillController = SkillController = __decorate([
    (0, routing_controllers_1.Controller)('/skills'),
    __metadata("design:paramtypes", [])
], SkillController);
