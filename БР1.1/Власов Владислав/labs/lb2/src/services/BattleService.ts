...
export class BattleService implements IBattleService
{
    ...
    async Attack(ownerId: number, attackCharId: number, defenceCharId: number): Promise<void> {
        ...
        const attacker = await this._characterService.getCharacter(ownerId, attackCharId) as Character
        const defencer = await this._characterService.getCharacter(ownerId, defenceCharId) as Character
        
        const attackerUniversalEffects = await this._characterService.getCharEffects(ownerId, attackCharId, EffectType.Universal) as Effect[]
        const defencerUniversalEffects = await this._characterService.getCharEffects(ownerId, defenceCharId, EffectType.Universal) as Effect[]
        const attackerAttackEffects = await this._characterService.getCharEffects(ownerId, attackCharId, EffectType.Attact) as Effect[]
        const defencerDefenceEffects = await this._characterService.getCharEffects(ownerId, defenceCharId, EffectType.Defence) as Effect[]
        ...
        {
            const conditions = (await this._effectService.getConditions(effect.id) as Condition[]).sort((a, b) => 
        ...
        await this._characterService.updateCharacter(ownerId, defenceCharId, updatingChar)
    }
