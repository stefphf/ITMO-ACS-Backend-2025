...
export class TransactionEntity implements Transaction {
  ...
  @ApiProperty({ description: 'Сумма бонуса', required: false, type: Number })
  bonus_amount: number;
  @ApiProperty({
...
export class TransactionResponseEntity {
  @ApiProperty({ description: 'Транзакции', type: [TransactionEntity] })
  transactions: TransactionEntity[];
  @ApiProperty({ description: 'Общее количество транзакций', type: Number })
  total_items: number;
}
