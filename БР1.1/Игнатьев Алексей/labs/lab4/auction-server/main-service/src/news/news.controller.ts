...
import { NewsEntity, NewsResponseEntity } from './entities/news.entity';
...
@Controller('news')
export class NewsController extends CommonController {
  constructor(private readonly newsService: NewsService) {
    super(newsService);
  }

  @Get()
  @ApiResponse({ type: NewsResponseEntity })
  async findAll(@Query() params: PaginateParams): Promise<NewsResponseEntity> {
