...
import {LivingResponseDto} from "@rent/shared";
...
export function createLivingDtoToModel(dto: CreateLivingRequestDto): CreateLivingModel {
    return {
        ...
        flat: dto.flat ? createFlatDtoToModel(dto.flat) : undefined,
        room: dto.room ? createRoomDtoToModel(dto.room) : undefined,
        countryHouse: dto.countryHouse ?  createCountryHouseDtoToModel(dto.countryHouse) : undefined,
    };
}
