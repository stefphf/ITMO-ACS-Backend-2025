...
const job_route_1 = __importDefault(require("./route/job.route"));
const application_route_1 = __importDefault(require("./route/application.route"));
...
app.use("/api", job_route_1.default);
