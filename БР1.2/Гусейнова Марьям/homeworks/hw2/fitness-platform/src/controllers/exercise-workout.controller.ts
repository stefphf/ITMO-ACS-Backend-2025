...
export class ExerciseWorkoutController {
  async getAllExerciseWorkouts(req: Request, res: Response): Promise<void> {
    try {
  ...
  async getExerciseWorkoutById(req: Request, res: Response): Promise<void> {
  ...
  async createExerciseWorkout(req: Request, res: Response): Promise<void> {
    try {
  ...
  async updateExerciseWorkout(req: Request, res: Response): Promise<void> {
    const id = parseInt(req.params.id, 10);
    try {
  ...
  async deleteExerciseWorkout(req: Request, res: Response): Promise<void> {
    const id = parseInt(req.params.id, 10);
    try {
