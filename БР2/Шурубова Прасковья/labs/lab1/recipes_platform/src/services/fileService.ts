...
app.post("/files/create", async (req: Request, res: Response): Promise<void> => {
...
app.put("/files/update/:id", async (req: Request, res: Response): Promise<void> => {
    const repo = AppDataSource.getRepository(File);
...
app.delete("/files/delete/:id", async (req: Request, res: Response): Promise<void> => {
