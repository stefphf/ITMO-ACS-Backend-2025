...
app.post("/comments/create", async (req: Request, res: Response): Promise<void> => {
...
app.put("/comments/update/:id", async (req: Request, res: Response): Promise<void> => {
    const repo = AppDataSource.getRepository(Comment);
...
app.delete("/comments/delete/:id", async (req: Request, res: Response): Promise<void> => {
