...
app.post("/favourites/create", async (req: Request, res: Response): Promise<void> => {
...
app.put("/favourites/update/:id", async (req: Request, res: Response): Promise<void> => {
    const repo = AppDataSource.getRepository(Favourite);
...
app.delete("/favourites/delete/:id", async (req: Request, res: Response): Promise<void> => {
