...
app.post("/ratings/create", async (req: Request, res: Response): Promise<void> => {
...
app.put("/ratings/update/:id", async (req: Request, res: Response): Promise<void> => {
    const repo = AppDataSource.getRepository(Rating);
...
app.delete("/ratings/delete/:id", async (req: Request, res: Response): Promise<void> => {
