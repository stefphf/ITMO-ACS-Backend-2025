...
app.post("/collections/create", async (req: Request, res: Response): Promise<void> => {
...
app.put("/collections/update/:id", async (req: Request, res: Response): Promise<void> => {
    const repo = AppDataSource.getRepository(Collection);
...
app.delete("/collections/delete/:id", async (req: Request, res: Response): Promise<void> => {
