...
app.post("/categories/create", async (req: Request, res: Response): Promise<void> => {
...
app.put("/categories/update/:id", async (req: Request, res: Response): Promise<void> => {
    const repo = AppDataSource.getRepository(Category);
...
app.delete("/categories/delete/:id", async (req: Request, res: Response): Promise<void> => {
