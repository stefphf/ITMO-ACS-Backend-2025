...
app.post("/articles/create", async (req: Request, res: Response): Promise<void> => {
...
app.put("/articles/update/:id", async (req: Request, res: Response): Promise<void> => {
    const repo = AppDataSource.getRepository(Article);
...
app.delete("/articles/delete/:id", async (req: Request, res: Response): Promise<void> => {
